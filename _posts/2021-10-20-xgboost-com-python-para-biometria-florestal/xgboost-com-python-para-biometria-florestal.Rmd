...
No último [texto](https://theilonmacedo.netlify.app/post/2021-09-24-predizendo-o-volume-de-eucalipto-com-tidymodels-de-forma-reprodutivel/) que escrevi, o XGBoost foi o melhor modelo ajustado dentre todos os que foram testados. Um colega que leu o texto me solicitou um auxílio para ajustar este modelo usando Python, já que essa é a linguagem que ele possui maior domínio. Então decidi aproveitar e escrever um breve tutorial sobre esse ajuste.   
