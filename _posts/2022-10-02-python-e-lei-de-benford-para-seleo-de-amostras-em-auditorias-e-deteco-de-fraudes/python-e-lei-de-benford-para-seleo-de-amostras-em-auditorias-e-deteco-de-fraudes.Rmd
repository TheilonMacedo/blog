...
Como o dataset, diferente da vida real, possui uma coluna `Class` indicando fraudes (1) e não-fraudes (2), podemos investigar o quanto os valores identificados ('99', '89', '19', '10') correspondem a fraudes na base completa:  
